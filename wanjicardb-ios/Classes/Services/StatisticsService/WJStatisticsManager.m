...
{
   return [MobClick getConfigParams];
}
...
- (void)event:(NSString *)eventId label:(NSString *)label acc:(NSInteger)accumulatio
{
    [MobClick event:eventId label:label acc:accumulatio];
}
