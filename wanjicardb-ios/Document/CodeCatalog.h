...
Payment
    ...
    "WJFindPayPasswordController"         找回密码
    "WJPayPsdIndentifyVerifyController"   找回密码身份验证
    "WJPaySettingController"              支付设置


Recharge
    "WJPayInfoController"                 支付信息
...
Login -- 领卡页面
    ...
    "WJFreeCardsViewController"             免费领卡
