...
{
    return [UIHelper colorWithHexColorString:@"f9f9f9"];
}

+ (UIColor *)getStatusBarTextColor
{
    return [UIHelper getUIColorWithRed:0 green:0 blue:0];
}
...
{
    return  [self colorWithHexColorString:@"494949"];
}
...
+ (UIColor *)randomColor
{
    return [UIHelper getUIColorWithRed:arc4random()%256 green:arc4random()%256 blue:arc4random()%256];
}
